var vrtConf = {
    ...
    'videoData' : [
        {'path':  'http://www.youtube.com/watch?v=1Ft5HY-w31Y', 'length': 10, 'name' : 'Chrono test 1'}
        ,{'path': 'http://www.youtube.com/watch?v=lYhtNU869KM', 'length': 10, 'name' : 'Chrono test 2'}
        ,{'path': 'http://www.youtube.com/watch?v=FxmsUSn8uHI', 'length': 10, 'name' : 'Chrono test 2'}
    ],

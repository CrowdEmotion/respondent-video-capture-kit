...
/******/([
    ...
    /***/ function (module, exports) {
        ...
        /******/([
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                FlashProducer.prototype = {
                    flash_methods_prepare: function () {
                        ...
                        this.methods.forEach(function (method) {
                            if (self[method]) {
                                return;
                            } // we don't overwrite existing definitions
                ...
                // Things we want to expose to requiring libraries
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        var $, Adapter, ContentsMixin, EventEmitterMixin, FlashProducer, HTML5Producer, Hub, JanusRecorder, JobsMixin, LoggingMixin, TimedMetadataMixin, Urls, mixins,
            bind = function (fn, me) {
                return function () {
        ...
        HTML5Producer = (function (superClass) {
            ...
            function HTML5Producer(options) {
                ...
                this.slowLinkThrottleTime = 5000;
                this.slowLinkThrottlePercent = 0.5;
                this.adaptationStatus = 0;
                this.rampUpStartTimeout = 10000;
                this.adaptationRampUpSize = 10000;
                this.adaptationRampUpTime = 3000;
                this.adaptationMinBitrate = 32000;
                this.adaptationMaxBitrate = 512000 * 2;
                this.previewStart();
                this.janusLibInit();
            }
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        JanusRecorder = (function () {
            ...
            JanusRecorder.prototype.sessionError = function (error) {
                return this.log('session error', error);
            };
        ...
        function Janus(gatewayCallbacks) {
            ...
            function prepareWebrtc(handleId, callbacks) {
                ...
                if (callbacks.stream && (!callbacks.stream.ended)) {
                    // we try to re-use the provided stream so that te use does not have to
                    // re-click allow
                ...
                config.pc.createOffer(
                    function (offer) {
                        ...
                        if (config.mySdp === null || config.mySdp === undefined) {
                            ...
                            // HACK http://stackoverflow.com/a/16868123/384336
